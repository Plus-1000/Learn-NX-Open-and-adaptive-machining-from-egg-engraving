...
> </b>
>>If the PC to CNC connection is ready, you can read the point coordinate file from the PC, or copy it to the PC, run apps and import points to NX CADCAM interface. 
