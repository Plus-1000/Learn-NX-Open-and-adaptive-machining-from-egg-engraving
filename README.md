...
>> Open journal codes, change the Drive Geometry with the face which is named "EXTRACT01" then build .dll file, then run it from NX CADCAM interface, toolpath will be generated. 
<br/>
