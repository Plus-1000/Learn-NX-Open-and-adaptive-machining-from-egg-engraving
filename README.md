...
Part deformation can be checked by probe or scanner, here we use the probe as an example: <br>

&ensp； When the probe hits part along the Z direction, we can get the Z coordinate of the destining point, the reading pt in the diagram below.
