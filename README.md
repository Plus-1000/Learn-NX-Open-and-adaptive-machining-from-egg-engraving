...
This is a fictional attempt to unveil the mystery behind CNC egg engraving
...
Every egg is unique, there are two key points when carving an egg, detecting the shape of the egg and automatically generating a toolpath, So the machining process can be split into two steps: 
